...
setFactorLevels = 1; % 0 For Debug following steps ,
...
switch  setFactorLevels 
    case 0 
        ...
        factorAndLevels{1}= [ 12 24 ];                               % num of input nodes 
        factorAndLevels{2}= [ 6 , 12 , 24 ];                         % num of hidden nodes
        factorAndLevels{3}= [ 5 , 6 ];                               % num of learning Algorith 
        % factorAndLevels{4}= [ 0.2 , 0.1 , 0.05 , 0.01];            % learning rate
        factorAndLevels{4}= [ 0.1 ];                                 % learning rate
        factorAndLevels{5}= [ 1 5 ];                            % trainning cycle  * 10^3
        
    case 1
        factorAndLevels{1}= [ 7 , 14 , 28 , 50];                      % num of input nodes 
        factorAndLevels{2}= [ 7 , 14 , 21 , 28 , 45 , 56 , 84 , 100]; % num of hidden nodes
        factorAndLevels{3}= [ 5 , 6];                                 % num of learning Algorith (r-prop and scg) 
        factorAndLevels{4}= [ 0.2 , 0.1 , 0.05 , 0.01];               % learning rate
        factorAndLevels{5}= [ 1 5 10 20];                             % trainning cycle  * 10^3

    case 2
        factorAndLevels{1}= [ 28, 50, 76,];                           % num of input nodes 
        factorAndLevels{2}= [ 28, 50, 76, 152];                       % num of hidden nodes
...
fclose(fid);
 ...
 % note: review/indicate what is the purpose of this source code, and why it is "placed" here
 %{
