function [ output_args ] = func_03_ann4tsf_experiments_v05(  geneneralFileRes,...
    ...
    initTime = tic; 
    %% ******************************************************************************************
    %  PRE-ALLOCATION FOR PARAMETERS - THIS CAN NOT BE DONE WITH PARFOR TOOL
    ...
    %% GETTING THE X% BEST  ====================================================================
    % This part cannot be done in parallel
    
    % Data: resultsCellArray{iExperiment};  -> a cell array  
    %       annParameters{iExperiment};     -> a cell array
    %       parameters.getPrctBest = X      -> 
    
    % -----------------------------------------------
    % resultsCellArray{}.rmseValHT1  
    % resultsCellArray{}.smapeValHT1
    
    % resultsCellArray{}.rmseTestHT1
    % resultsCellArray{}.smapeTestHT1
    
    % resultsCellArray{}.rmseValHT2
    % resultsCellArray{}.smapeValHT2
    
    % resultsCellArray{}.rmseTestHT2
    % resultsCellArray{}.smapeTestHT2
    % ------------------------------------------------
    % 
    % resultsCellArrayBestRmseValHT1 = sortResultsByErrorSubsetHorizon( resultsCellArray , string('rmse') , string('val') , string('HT1') );
    resultsCellArrayBestRmseValHT1 = 
    % resultsCellArrayBestSmapeValHT1
    
    % resultsCellArrayBestRmseValHT2
    % resultsCellArrayBestSmapeValHT2
    
    % resultsCellArrayBestRmseTestHT1
    % resultsCellArrayBestSmapeTestHT1
    
    % resultsCellArrayBestRmseTestHT2
    % resultsCellArrayBestSmapeTestHT2
    
    
    % X Prct Best in validation error 
    
    
    % X Prct Best in test error 
