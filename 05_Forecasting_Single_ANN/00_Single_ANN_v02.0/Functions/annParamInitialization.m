function [ parameters ] = annParamInitialization( input_args )
    ...
    parameters.iExperiment      = 0;         % read value from file of parameters
    parameters.iCombFactLevel   = 0; 
    ...
    parameters.showOnScreen         = false;
    parameters.netView              = false;
    parameters.showTrainRecord      = true;

    parameters.showTrainTargetOutput = false;
    parameters.showValTargetOutput   = true;
    parameters.showTestTargetOutput  = false;
    parameters.showTrainValTestTargetOutput = false;
