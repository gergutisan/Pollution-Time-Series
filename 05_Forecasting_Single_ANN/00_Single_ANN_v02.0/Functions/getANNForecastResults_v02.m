function forecastResults = getANNForecastResults_v02( net , trainRecord , x , t )
    ...
    rmseTestH2Forecast  = sqrt( sum ( ( testH2Outputs - testH2Targets).^2 ) / numel( testTargets ) );
    errorEachPeriod   = ( abs(testH2Outputs - testH2Targets) ) ./ ( abs(testH2Outputs) + abs(testH2Targets) );
    smapeTestH2Forecast = 100 * ( 2* sum(errorEachPeriod) ) / numel( testTargets ); 
    clear errorEachPeriod;
    ...
    forecastResults.rmseTestH2Forecast   = rmseTestH2Forecast; 
    ...
    forecastResults.smapeTestH2Forecast   = smapeTestH2Forecast;
