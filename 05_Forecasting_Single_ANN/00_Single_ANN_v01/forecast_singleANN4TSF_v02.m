function [resultsData , net01 , parameters] = forecast_singleANN4TSF_v02 ( parameters )
    ...
    % resultsData.parameters = parameters;
    ...
    tsFilename          = parameters.tsFilename;
    ...
    % tsData = load( fullfile(folderTimeSeries,'ts-NO2-FedzLadreda-16-12.csv' ));  % FOR DEBUGGING
    tsData = load( fullfile(folderTimeSeries,tsFilename ));
    % plot(tsData); 
    
    resultsData.tsData  = tsData;
    ...
    resultsData.trainTargets  = trainTargets;
    resultsData.trainOutputs  = trainOutputs;
    
    resultsData.valTargets   = valTargets;
    resultsData.testTargets  = testTargets;
    ...
    resultsData.rmseTrain          = rmseTrain;
    resultsData.rmseValH1Forecast  = rmseValH1Forecast;
    resultsData.rmseTestH1Forecast = rmseTestH1Forecast;
    ...
    resultsData.smapeTrain          = smapeTrain;
    resultsData.smapeValH1Forecast  = smapeValH1Forecast;
    resultsData.smapeTestH1Forecast = smapeTestH1Forecast;
    ...
    elseif ( horizon > 1 )
        ...
        resultsData.valH2Outputs  = valH2Outputs;
        resultsData.testH2Outputs = testH2Outputs;
        ...
        % ----------------------------------------------
        resultsData.rmseValH2Forecast  = rmseValH2Forecast;
        resultsData.smapeValH2Forecast = smapeValH2Forecast;
        resultsData.rmseTeH2Forecast   = rmseTeH2Forecast;
        resultsData.smapeTeH2Forecast  = smapeTeH2Forecast;
