...
parameters.ForecastHorizon    = 72;   % => number of forecasted values generated 
...
parameters.max_fail_TrainCyclesPrct = 50;  % If 100% train till the max number of cycles, 
...
% parameters.debugging    = 'D_0012';   % done (but needs to be reviewd)
parameters.debugging    = 'D_0010';   % done (but needs to be reviewd)
...
switch parameters.debugging
    ...
    case 'D_0010'
        ...
        % parameters.tsOriginalDataFileRoots = { 'PM25-MendezAlvaro-16-10'};
