...
switch  factorsAndLevelsOption
    ...
    case 1 % -----------------------------------------------------------------
        ...
        %}
        % listLearnAlgStr  = {'trainlm', 'traingd', 'traingda', 'traingdx', 'trainrp', 'trainscg', 'traingdm'};
        % listLearnAlgStr  = {'trainlm', 'trainrp', 'trainscg'}; listLearnAlg  = {1,5,6};
        listLearnAlgStr  = {'trainrp', 'trainscg'}; listLearnAlg  = { 5 , 6 };
    ...
    case 2  % -----------------------------------------------------------------
        ...
        % POLLUTION RAW DATA - INPUT AND HIDDEN LAYER
        ...
        % listLearnAlgStr  = {'trainlm', 'traingd', 'traingda', 'traingdx', 'trainrp', 'trainscg', 'traingdm'}; listLearnAlg  = { 1 , 2 , 3 , 4 , 5 , 6 , 7 };
        % listLearnAlgStr  = {'trainlm', 'trainrp', 'trainscg'}; listLearnAlg  = { 1 , 5 , 6 };
        listLearnAlgStr  = {'trainrp', 'trainscg'};  listLearnAlg  = { 5 , 6 };
