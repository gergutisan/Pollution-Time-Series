function [ACF,lags,bounds,  h1_scatter , h2_acf] = studyAutocorrelation( tsData , tsName, sInfo, numLags, showPlot1 , showPlot2  )
    ...
    if ( showPlot1 )
        ...
        h1_scatter = figure('Name',strcat(tsName,' ',sInfo,' ',' ACF lags-',num2str(numLags2) ) );
    ...
    % Correlogram
    if ( showPlot2 )        
        h2_acf = figure('Name',strcat(tsName,' ',sInfo ,' ',' ACF lags-',num2str(numLags) ) );
