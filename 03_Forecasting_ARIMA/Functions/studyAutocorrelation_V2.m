function [ ACF, lags, bounds, h , errorMsg,errorV] = studyAutocorrelation_V2(  tsDataCellArray, ...
                                                                     tsNamesCellArray,...
                                                                     numOfLags,...
                                                                     folder, ...
                                                                     filename, ...
...
%}
    ...
    % ------------------
    ACF = cell( 1 ,  length(tsDataCellArray));
    ...
    for i = 1:length(tsDataCellArray)
        ...
        [ ACF{i} , lags{i} , bounds{i}] = autocorr(tsData,numOfLags); 
