function [ PACF, lags, bounds, h , errorMsg,errorV] = studyPartialAutocorrelation_V3(  tsData, ...
                                                                     tsName,...
                                                                     numOfLags,...
                                                                     folder, ...
                                                                     filename, ...
...
%   Get data for ACF of ONE time series, it aslo can show and/or a figure
...
%}
    % initialization    
    PACF = 0; lags = 0; bounds = 0; h = 0;errorMsg = ''; errorV = 0;
        
    % ----------------------------------------------
    % PACF = zeros(1,numOfLags);
    ...
    parcorr(tsData,numOfLags); 
    title(strcat(tsName," PACF lags ",num2str(numOfLags)," numData ", num2str( length(tsData) ) ) );
