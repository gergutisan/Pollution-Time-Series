...
%for indexTs = 4:4
    ...
    switch tsName
        ...
        case 'NO2-PzCastilla-16-10'
            ...
            Constant = 0; D = 0; Seasonality = 72; MALags = [1]; SMALags = [1];
            ARLags = [ 1 ];
            SARLags = [ 1 ];
            setARIMAOpt = 2; 
        ...
        case 'PM25-MendezAlvaro-16-10'
            Constant = 1; D = 0; Seasonality = 72; MALags = 24; SMALags = 24;
            setARIMAOpt = 2; 
...
%%
    ...
    % Constant = 1; D = 1; Seasonality = 12; MALags = 24; SMALags = 24;
     ...
     elseif ( setARIMAOpt == 2) 
        ...
        toEstMd1 = arima('Constant',Constant,'D',D,'Seasonality',Seasonality, 'ARLags', ARLags, 'SARLags', SARLags);
        %toEstMd1 = arima('Seasonality',Seasonality);
     end
